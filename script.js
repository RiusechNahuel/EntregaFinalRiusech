    ...
    .then(productos => {
        ...
        function esconder(e) {
            ...
            if (carrito.length == 0) {
                ...
                boton.innerHTML = `<a type="button" class="btn btn-success" href="index.html">Ir a la Tienda</a>`;
                contenedor.append(boton);
            } else {
                let boton = document.createElement("div");
                boton.className = "boton-render";
                boton.innerHTML = `<a type="button" class="btn btn-success" href="index.html">Seguir comprando</a>`;
                contenedor.append(boton);
            }
        }
